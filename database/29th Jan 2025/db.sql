...
CREATE TABLE `campaigns` (
  ...
  CONSTRAINT `campaigns_ibfk_63` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `campaigns_ibfk_64` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `campaigns_ibfk_65` FOREIGN KEY (`templateId`) REFERENCES `templates` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `countries` (
  ...
  UNIQUE KEY `iso_code_9` (`iso_code`),
  UNIQUE KEY `iso_code_10` (`iso_code`),
...
CREATE TABLE `customers` (
  ...
  KEY `businessId` (`businessId`),
  CONSTRAINT `customers_ibfk_43` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `customers_ibfk_44` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `email_templates` (
  ...
  UNIQUE KEY `template_key_20` (`template_key`),
  UNIQUE KEY `template_key_21` (`template_key`),
...
CREATE TABLE `employees` (
  ...
  KEY `businessId` (`businessId`),
  CONSTRAINT `employees_ibfk_23` FOREIGN KEY (`userId`) REFERENCES `users` (`id`),
  CONSTRAINT `employees_ibfk_24` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `expense_categories` (
  `id` int NOT NULL AUTO_INCREMENT,
  `businessId` int NOT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Category name (e.g., Travel, Food, Equipment)',
  `code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Short code for the category',
  ...
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'fa-receipt' COMMENT 'Font Awesome icon class',
  `color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '#6366f1' COMMENT 'Color code for UI display',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `expense_requests` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description/purpose of the expense',
  `merchantName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Vendor/Merchant name',
  `receiptUrl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Path/URL to uploaded receipt',
  `receiptFileName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Original filename of receipt',
  `status` enum('DRAFT','PENDING','APPROVED','REJECTED','PAID','CANCELED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT',
  ...
  `paymentReference` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Payment transaction reference',
  `managerNote` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Note from approver',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `leave_approvals` (
  ...
  CONSTRAINT `leave_approvals_ibfk_37` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_approvals_ibfk_38` FOREIGN KEY (`leaveRequestId`) REFERENCES `leave_requests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_approvals_ibfk_39` FOREIGN KEY (`approverId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `leave_balances` (
  ...
  CONSTRAINT `leave_balances_ibfk_37` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_balances_ibfk_38` FOREIGN KEY (`employeeId`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_balances_ibfk_39` FOREIGN KEY (`leaveTypeId`) REFERENCES `leave_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `leave_requests` (
  ...
  CONSTRAINT `leave_requests_ibfk_81` FOREIGN KEY (`businessId`) REFERENCES `businesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_requests_ibfk_82` FOREIGN KEY (`employeeId`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_requests_ibfk_83` FOREIGN KEY (`leaveTypeId`) REFERENCES `leave_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `leave_requests_ibfk_84` FOREIGN KEY (`approverId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `message_logs` (
  ...
  KEY `templateId` (`templateId`),
  CONSTRAINT `message_logs_ibfk_64` FOREIGN KEY (`campaignId`) REFERENCES `campaigns` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `message_logs_ibfk_65` FOREIGN KEY (`customerId`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `message_logs_ibfk_66` FOREIGN KEY (`templateId`) REFERENCES `templates` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `role` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'shop_owner',
...
INSERT INTO `users` VALUES (9,NULL,'Admin','User',NULL,'admin@demo.com','$2b$10$5dM8mZFUzh70TckEsqcb4.cEm1odpoGP2NNPFIcM8BqFQB./6J.vC','SUPER_ADMIN','active','5919e284025bbedf575e3737e527c16cd3a1db4a42e1384921f93c85d5ec9a77','2026-01-20 13:39:00','2026-01-12 17:20:44','2026-01-13 13:39:00'),(10,NULL,'Super','Admin',NULL,'super@seecog.com','$2b$10$hGxphFZAjJPOaUunQ.oSOOTTA2ewJzd9oustvVMQwv64IX6Ut4oqi','SUPER_ADMIN','active','566b2569e1a06cc94dc3123a0966604109c3b019356bf8279fc0c298903538f6','2026-01-20 13:30:29','2026-01-13 13:28:54','2026-01-13 13:30:29'),(11,NULL,'HR','Manager',NULL,'hr@demo.com','$2b$10$ixdWLsuZyMOqgVTWRP.fQu7oBSIPiMoKr6xrEqHYpGpz6SgZNwd02','user','active','e853c23ea106cfe83901684f08a4140b478ab8eeea755e63d2bf381b56845bf1','2026-01-22 07:37:22','2026-01-13 13:28:54','2026-01-15 07:37:22'),(12,NULL,'HR','Executive',NULL,'hrexec@demo.com','$2b$10$jJbjou3xVYGweRJ2IwjUeeSdBXgofThhf8gELRNENmk4Q4KNWAF22','user','active',NULL,NULL,'2026-01-13 13:28:54','2026-01-13 13:28:54'),(13,NULL,'Finance','User',NULL,'finance@demo.com','$2b$10$kpRiW3xY5PX.oEqrLSGJOO5CeUsaTteVO96V0HE9Fv.6Wi4NeRnZm','user','active','a8b65ed28a13beac73e21b3a022fbf1c2a0a56ab49e36863eecf96a09120e95e','2026-01-20 13:41:49','2026-01-13 13:28:54','2026-01-13 13:41:49'),(14,NULL,'Team','Manager',NULL,'manager@demo.com','$2b$10$gsnIEOVmOyeHwlOucTvzU.ooN1PJWzCSFl/CM/rsTwgEi24.YWx3y','MANAGER','active',NULL,NULL,'2026-01-13 13:28:54','2026-01-13 13:28:54'),(15,NULL,'John','Employee',NULL,'employee@demo.com','$2b$10$rs2P3ZytMSrL9guWDkly.uPRpvQ68QTzv874SspXPpuX8iS7UI6uq','user','active',NULL,NULL,'2026-01-13 13:28:54','2026-01-13 13:28:54'),(16,NULL,'Rajesh','Seecog','+916261217249','rajesh@seecogsoftwares.com','$2b$10$VsImT2E7SZfOO.ihQ3QhvOHT5fP3dg0FWcCggOxiixkeVcKLIR67y','shop_owner','active','24ac0c5415b0c84eb162f2d9f4c927c04cb75b02f7cb7631bca39070d57b7218','2026-02-06 04:09:48','2026-01-29 08:31:47','2026-01-30 04:09:48');
...
-- Dump completed on 2026-01-30  9:47:05
