...
import documentApprovalRoutes from './routes/documentApproval.routes.js';
import exitWorkflowRoutes from './routes/exitWorkflow.routes.js';
import onboardingWorkflowRoutes from './routes/onboardingWorkflow.routes.js';
import contractWorkflowRoutes from './routes/contractWorkflow.routes.js';
import ppoWorkflowRoutes from './routes/ppoWorkflow.routes.js';
import payrollLifecycleRoutes from './routes/payrollLifecycle.routes.js';
...
app.use(documentApprovalRoutes);
app.use(exitWorkflowRoutes);
app.use(onboardingWorkflowRoutes);
app.use(contractWorkflowRoutes);
app.use(ppoWorkflowRoutes);
app.use(payrollLifecycleRoutes);
