...
const Employee = sequelize.define(
  ...
  },
  {
    ...
    timestamps: true,
    indexes: [
      { name: 'idx_employees_userId_empId', unique: true, fields: ['userId', 'empId'] },
      { name: 'idx_employees_userId_empEmail', unique: true, fields: ['userId', 'empEmail'] },
      { name: 'idx_employees_userId_empPhone', unique: true, fields: ['userId', 'empPhone'] },
      { name: 'idx_employees_userId_isActive', fields: ['userId', 'isActive'] },
