...
const AttendanceDailySummary = sequelize.define(
  'AttendanceDailySummary',
  {
    ...
    firstInAt: { type: DataTypes.DATE, allowNull: true },
    lastOutAt: { type: DataTypes.DATE, allowNull: true },
    workMinutes: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
    ...
    status: {
      type: DataTypes.ENUM('PRESENT', 'ABSENT', 'HALF_DAY', 'LEAVE', 'HOLIDAY', 'WEEKOFF'),
      allowNull: false,
      defaultValue: 'ABSENT',
    },
    source: {
